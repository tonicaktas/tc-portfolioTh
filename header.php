...
<html class="no-js" lang="en">
  <head>
    ...
    <?php wp_head(); ?> <!--säger att nu är head färdig och om det finns nått att ladda här ska det göras  -->
  ...
  <nav>
    ...
    <?php
      ...
      $defaults = array (
        'container' => false, // säger till att inte ta me default menu i diven
        'theme_location' => 'primary-menu', // säger till vart menu som vi ska ha är
        'menu_class' => 'no-bullet' // säger vilket class menu ska ha
    );
